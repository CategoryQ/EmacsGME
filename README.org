...
EmacsGME is a GameMaster emulator in the style of MythicGME/CRGE/etc, produced in emacs-lisp for playing solo-roleplaying games entirely within text/org-mode documents.
...
- v0.2-pre - Added list handling and basic game state display
...
- Handle the "New NPC" random event more gracefully
- Update this README to better reflect the reality of usage
